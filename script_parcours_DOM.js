...
console.log(document.querySelectorAll("ol")[0].querySelectorAll("li.compte-moi"));
...
console.log(document.querySelector('div').childNodes[3].childNodes[1].textContent);   
console.log(document.querySelector('div').children[1].children[0].textContent);   
// Méthode supp à voir en allant chercher le 2eme lu et 1er li ? Si existe ?